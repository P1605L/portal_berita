...
// Mendapatkan berita kategori olahraga
$berita_olahraga = getBerita($koneksi, null, 'olahraga');

// Proses pencarian
$hasil_pencarian = [];
if (isset($_GET['cari']) && isset($_GET['keyword']) && !empty($_GET['keyword'])) {
    $keyword = mysqli_real_escape_string($koneksi, $_GET['keyword']);
    $hasil_pencarian = getBerita($koneksi, null, 'olahraga', $keyword);
}

// Judul halaman
$page_title = "Berita Olahraga - NewsPedia";
?>
<!DOCTYPE html>
<html lang="id">
<head>
...
<body>
        ...
        <div class="container header-container">
            ...
            <nav>
                <ul class="nav-menu">
                    ...
                    <li><a href="olahraga.php" class="active">Olahraga</a></li>
                </ul>
            </nav>
            
            <form class="search-form" method="GET" action="olahraga.php">
    ...
    <div class="mobile-nav">
        ...
        <form class="search-form" method="GET" action="olahraga.php" style="margin-top: 20px;">
            <input type="text" name="keyword" placeholder="Cari berita..." value="<?php echo isset($_GET['keyword']) ? htmlspecialchars($_GET['keyword']) : ''; ?>">
            <button type="submit" name="cari"><i class="fas fa-search"></i></button>
        </form>
    </div>
    ...
    <section class="category-hero">
        <div class="container">
            ...
            <p>Informasi terkini seputar dunia olahraga, pertandingan, kompetisi, dan prestasi atlet Indonesia di kancah nasional dan internasional</p>
        </div>
    </section>
    ...
    <div class="breaking-news">
        <div class="container">
            <div class="ticker-container">
                <div class="ticker-label">BERITA OLAHRAGA</div>
                <div class="ticker-content">
                    • Timnas Indonesia Lolos ke Piala Asia 2023 • Persib vs Persija Berakhir Imbang 1-1 • Atlet Bulutangkis Indonesia Raih Emas di SEA Games • Formula 1: Max Verstappen Juara Musim Ini •
                </div>
            </div>
        </div>
    </div>
    ...
    <main class="container">
        ...
        <div class="search-results">
            ...
            <div class="news-grid">
                ...
                <div class="news-card">
                    ...
                    $img_src = "https://placehold.co/600x400/ef4444/ffffff?text=" . urlencode($berita['judul']);
                    ...
                    <div class="news-content">
                        <span class="news-category"><?php echo isset($berita['kategori']) ? ucfirst($berita['kategori']) : 'Olahraga'; ?></span>
                        <h3 class="news-title">
        ...
        <h2 class="section-title">Berita Olahraga Terkini</h2>
        
        <?php if (empty($berita_olahraga)): ?>
            <div style="text-align: center; padding: 40px 0; color: var(--gray-color);">
                ...
                <p>Tidak ada berita olahraga saat ini.</p>
            </div>
        <?php else: ?>
            <div class="news-grid">
                <?php foreach ($berita_olahraga as $berita): ?>
                <div class="news-card">
                    <?php
                    // Tampilkan gambar dari database jika ada
                    $gambar_path = isset($berita['gambar']) ? $berita['gambar'] : '';
                    ...
                    <img src="<?php echo $img_src; ?>" 
                         alt="<?php echo htmlspecialchars($berita['judul']); ?>" 
                         class="news-image"
                         onerror="this.onerror=null; this.src='https://placehold.co/600x400/ef4444/ffffff?text=Gambar+Tidak+Tersedia';">
