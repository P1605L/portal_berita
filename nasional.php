...
// Mendapatkan berita kategori nasional
$berita_nasional = getBerita($koneksi, null, 'nasional');

// Proses pencarian
$hasil_pencarian = [];
if (isset($_GET['cari']) && isset($_GET['keyword']) && !empty($_GET['keyword'])) {
    $keyword = mysqli_real_escape_string($koneksi, $_GET['keyword']);
    $hasil_pencarian = getBerita($koneksi, null, 'nasional', $keyword);
}

// Judul halaman
$page_title = "Berita Nasional - NewsPedia";
?>
<!DOCTYPE html>
<html lang="id">
<head>
...
<body>
        ...
        <div class="container header-container">
            ...
            <nav>
                <ul class="nav-menu">
                    ...
                    <li><a href="nasional.php" class="active">Nasional</a></li>
            ...
            <form class="search-form" method="GET" action="nasional.php">
    ...
    <div class="mobile-nav">
        ...
        <form class="search-form" method="GET" action="nasional.php" style="margin-top: 20px;">
            <input type="text" name="keyword" placeholder="Cari berita..." value="<?php echo isset($_GET['keyword']) ? htmlspecialchars($_GET['keyword']) : ''; ?>">
            <button type="submit" name="cari"><i class="fas fa-search"></i></button>
        </form>
    </div>
    ...
    <section class="category-hero">
        <div class="container">
            ...
            <p>Informasi terkini seputar berita dalam negeri, politik, pemerintahan, dan peristiwa penting di Indonesia</p>
        </div>
    </section>
    ...
    <div class="breaking-news">
        <div class="container">
            <div class="ticker-container">
                <div class="ticker-label">BERITA NASIONAL</div>
                <div class="ticker-content">
                    • Presiden Jokowi Resmikan Jalan Tol Trans Jawa • Pemilu 2024: KPU Umumkan Jadwal Pendaftaran • Indonesia Terima Bantuan Vaksin dari Jepang • Harga BBM Turun Mulai Besok • Gubernur DKI Resmikan Rumah DP 0 Rupiah •
                </div>
            </div>
        </div>
    </div>
    ...
    <main class="container">
            ...
            <div class="news-grid">
                ...
                <div class="news-card">
                    ...
                    <div class="news-content">
                        <span class="news-category"><?php echo isset($berita['kategori']) ? ucfirst($berita['kategori']) : 'Nasional'; ?></span>
                        <h3 class="news-title">
        ...
        <h2 class="section-title">Berita Nasional Terkini</h2>
        ...
        <?php if (empty($berita_nasional)): ?>
            <div style="text-align: center; padding: 40px 0; color: var(--gray-color);">
                ...
                <p>Tidak ada berita nasional saat ini.</p>
            </div>
        <?php else: ?>
            <div class="news-grid">
        ...
        document.querySelectorAll('.news-image').forEach(img => {
            img.addEventListener('error', function() {
                ...
                if (!this.hasAttribute('data-error-handled')) {
                    ...
                    this.src = 'https://placehold.co/600x400/2a4a7f/ffffff?text=Image+Not+Found';
                }
            });
        });
    </script>
