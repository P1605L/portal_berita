...
// Mendapatkan berita kategori ekonomi
$berita_ekonomi = getBerita($koneksi, null, 'ekonomi');

// Proses pencarian
$hasil_pencarian = [];
if (isset($_GET['cari']) && isset($_GET['keyword']) && !empty($_GET['keyword'])) {
    $keyword = mysqli_real_escape_string($koneksi, $_GET['keyword']);
    $hasil_pencarian = getBerita($koneksi, null, 'ekonomi', $keyword);
}

// Judul halaman
$page_title = "Berita Ekonomi - NewsPedia";
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <style>
        ...
        /* Sisanya sama dengan nasional.php */
        * {
            margin: 0;
            padding: 0;
...
<body>
        ...
        <div class="container header-container">
            ...
            <nav>
                <ul class="nav-menu">
                    ...
                    <li><a href="ekonomi.php" class="active">Ekonomi</a></li>
                    <li><a href="teknologi.php">Teknologi</a></li>
                    <li><a href="olahraga.php">Olahraga</a></li>
                </ul>
            </nav>
            
            <form class="search-form" method="GET" action="ekonomi.php">
    ...
    <div class="mobile-nav">
        ...
        <form class="search-form" method="GET" action="ekonomi.php" style="margin-top: 20px;">
            <input type="text" name="keyword" placeholder="Cari berita..." value="<?php echo isset($_GET['keyword']) ? htmlspecialchars($_GET['keyword']) : ''; ?>">
            <button type="submit" name="cari"><i class="fas fa-search"></i></button>
        </form>
    </div>
    ...
    <section class="category-hero">
        <div class="container">
            ...
            <p>Informasi terkini seputar bisnis, keuangan, investasi, pasar saham, dan perkembangan ekonomi Indonesia dan dunia</p>
        </div>
    </section>
    ...
    <div class="breaking-news">
        <div class="container">
            <div class="ticker-container">
                <div class="ticker-label">BERITA EKONOMI</div>
                <div class="ticker-content">
                    • IHSG Naik 1,5% di Penutupan Perdagangan Hari Ini • Bank Indonesia Pertahankan Suku Bunga Acuan di 5,75% • Rupiah Menguat terhadap Dolar AS • Ekspor Indonesia Tumbuh 15% pada Kuartal III •
                </div>
            </div>
        </div>
    </div>
    ...
    <main class="container">
        ...
        <div class="search-results">
            ...
            <div class="news-grid">
                ...
                <div class="news-card">
                    ...
                    $img_src = "https://placehold.co/600x400/14b8a6/ffffff?text=" . urlencode($berita['judul']);
                    ...
                    <img src="<?php echo $img_src; ?>" 
                         ...
                         class="news-image"
                         onerror="this.src='https://placehold.co/600x400/14b8a6/ffffff?text=Image+Error'">
                    
                    <div class="news-content">
                        <span class="news-category"><?php echo isset($berita['kategori']) ? ucfirst($berita['kategori']) : 'Ekonomi'; ?></span>
                        <h3 class="news-title">
        ...
        <h2 class="section-title">Berita Ekonomi Terkini</h2>
        ...
        <?php if (empty($berita_ekonomi)): ?>
            <div style="text-align: center; padding: 40px 0; color: var(--gray-color);">
                ...
                <p>Tidak ada berita ekonomi saat ini.</p>
            </div>
        <?php else: ?>
            <div class="news-grid">
                ...
                <div class="news-card">
                    ...
                    <img src="<?php echo $img_src; ?>" 
                         alt="<?php echo htmlspecialchars($berita['judul']); ?>" 
                         class="news-image"
                         onerror="this.onerror=null; this.src='https://placehold.co/600x400/14b8a6/ffffff?text=Gambar+Tidak+Tersedia';">
        ...
        document.querySelectorAll('.news-image').forEach(img => {
            img.addEventListener('error', function() {
                ...
                if (!this.hasAttribute('data-error-handled')) {
                    ...
                    this.src = 'https://placehold.co/600x400/14b8a6/ffffff?text=Image+Not+Found';
                }
            });
        });
    </script>
